        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                    @can('pos')
                    <li>
                        <a href="{{route('pos.show')}}"><em class="icon ni ni-dot-box-fill me-1"></em>POS</a>
                    </li>
                    @endcan
                    ...
                    <li class="dropdown language-dropdown d-none d-sm-block me-n1">
                        <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                            <div class="quick-icon border border-light">
                                ...
                                @elseif(Config::get('app.locale')  == 'ar')
                                    <img class="icon" src="{{asset('images/flags/saudi-sq.png')}}" alt="">
                                @endif
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                            <ul class="language-list">
                                <li>
                                    <a href="{{route('lang','en')}}" class="language-item">
                                        <img src="{{asset('images/flags/english.png')}}" alt="" class="language-flag">
                                        <span class="language-name">English</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('lang','ar')}}" class="language-item">
                                        <img src="{{asset('images/flags/saudi.png')}}" alt="" class="language-flag">
                        ...
                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-md-block">
                                    <div class="user-name dropdown-indicator">{{auth()->user()->mobile}}</div>
                                </div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    ...
                                    @endphp 
                                    <span>{{mb_substr($first_name, 0, 1, 'utf8')}}</span>
                                    </div>
                                    <div class="user-info">
                                        <span class="lead-text">{{auth()->user()->name}}</span>
                                        <span class="sub-text">{{auth()->user()->mobile}}</span>
                                    </div>
                                </div>
                            </div>
