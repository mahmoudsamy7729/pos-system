...
@section('title','Expenses Categories List')
@section('js-files')
<script>
    setTimeout(function() {
...
function Active(ID)
    {
        ...
        var url = "{{route('expenses.category.active',999999)}}";
                                        ...
                                        <div class="nk-block-head nk-block-head-sm">
                                            <div class="nk-block-between">
                                                <div class="nk-block-head-content">
                                                    <h3 class="nk-block-title page-title">Expense Categories List</h3>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>@if ($category->active == 1)
                                                                        <span style="cursor: pointer;" id="active_{{$category->id}}" class="badge bg-success" onclick="Active({{$category->id}})">Active</span>
                                                                        @elseif($category->active == 0)
                                                                        <span style="cursor: pointer;" id="active_{{$category->id}}" class="badge bg-danger" onclick="Active({{$category->id}})">Not Active</span>
                                                                    @endif</td>
