      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="row">
            ...
            <hr class="mt-3">
            <form class="row gy-4" action="{{route('sales.filter')}}" method="GET" style="font-weight: 600;">
              <div class="col-md-6 col-12">
                <div class="form-group">
                    <label class="form-label" for="date">{{__('sales date')}} </label>
              ...
              <div class="col-md-6 col-12" onclick="GetCustomers()">
                <div class="form-group">
                    <label class="form-label" for="customer_name">{{__('customer name')}}</label>
                    <div class="form-control-wrap">
                      <select    data-live-search="true" class="selectpicker" id="customers_list" name="customer" >
                        <option value="" selected ></option>
